...
use File::Spec;
use constant stacks_version => "1.40";
...
my $mysql_config = "/projects/rebe4957/gbs/programs/share/stacks/" . "sql/mysql.cnf";
my $mysql_tables = "/projects/rebe4957/gbs/programs/share/stacks/" . "sql/stacks.sql";
my $exe_path     = "/projects/rebe4957/gbs/programs/bin/";
my $out_path     = "";
my $popmap_path  = "";
my $sample_path  = "";
my $db           = "";
