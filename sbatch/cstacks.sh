...
#SBATCH --error=errorfiles/cstacks.err
...
###Type commands.
cstacks -o /projects/rebe4957/gbs_v_myrtillus/data/samples/stacks -s /projects/rebe4957/gbs_v_myrtillus/data/samples/stacks/Tripp_NoIndex_L005_R1_001 
